        ...
        val passwordBuilder = AlertDialog.Builder(this@HomeTabActivity)
            ...
            .setPositiveButton("확인") { dialog, which ->
                ...
                if (isCorrectPassword(enteredPassword)) {
                    ...
                    //회원정보 삭제 로직 추가
                    //1.DB에서 DATA 삭제
                    val userService = (applicationContext as com.matzip.find_my_matzip.MyApplication).userService
                    ...
                    call.enqueue(object: Callback<Unit> {
                        override fun onResponse(call: Call<Unit>, response: Response<Unit>) {
                            ...
                            if(response.isSuccessful) {
                                ...
                                // 스토리지 접근 도구 ,인스턴스
                                val storage =
                                    com.matzip.find_my_matzip.MyApplication.Companion.storage
                                // 스토리지에 저장할 인스턴스
                                ...
                                imgRef.delete().addOnCompleteListener {
                                    ...
                                    val intent = Intent(this@HomeTabActivity, com.matzip.find_my_matzip.LoginActivity::class.java)
                                    startActivity(intent)
